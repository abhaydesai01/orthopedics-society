...
const Events = () => {
  const events = [
    ...
    },
    {
      ...
      registrationLink:
        "https://docs.google.com/forms/d/e/1FAIpQLSeudIyNIKLZMtIgA8hrzGDAosZWloNrTgKbiJyxi93tiDuOdg/viewform",
    },
  ];
          ...
          <div key={event.id}>
            <div className="flex flex-col md:flex-row gap-12">
              <div className="w-full md:w-1/2">
                <div className="rounded-3xl overflow-hidden  transition-all duration-300 transform hover:-translate-y-2 h-full">
                  <img
                    src={event.image}
                    alt={event.title}
