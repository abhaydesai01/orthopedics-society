...
export default function OfficeBearers() {
  return (
    <div className="container mx-auto px-4 py-8 pt-16 lg:py-16 lg:pt-24">
      <h1 className="text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 text-center lg:text-left">
        Office Bearers
      </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-10 lg:mb-16">
        <div className="flex flex-col items-center">
          <img
            src="/image18.jpg"
            alt="Member 1"
            className="w-40 h-40 lg:w-48 lg:h-48 object-cover mb-3 lg:mb-4 rounded-lg"
          />
          <h3 className="text-lg lg:text-xl font-semibold text-center">
            Dr.Avinash<br></br> (President)
          </h3>
        </div>
        <div className="flex flex-col items-center">
          <img
            src="/office_bearer.jpeg"
            alt="Member 1"
            className="w-40 h-40 lg:w-48 lg:h-48 object-cover mb-3 lg:mb-4 rounded-lg"
          />
          <h3 className="text-lg lg:text-xl font-semibold text-center">
            Dr. Subodh Shetty<br></br> (President Elect)
          </h3>
        </div>
        <div className="flex flex-col items-center">
          <img
          ...
          />
          <h3 className="text-lg lg:text-xl font-semibold text-center">
            Dr. Shekhar <br></br>(Organising Secretary)
          </h3>
        </div>
        <div className="flex flex-col items-center">
          <img
        ...
        <div className="flex flex-col items-center">
          ...
          />
          <h3 className="text-lg lg:text-xl font-semibold text-center">
            Dr. Ravi Kumar<br></br>(Joint Secretary)
          </h3>
        </div>
        <div className="flex flex-col items-center">
          <img
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="border-2 border-blue-500 rounded-lg p-4 lg:p-6 shadow-lg bg-gradient-to-b from-blue-50 to-white hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-xl lg:text-2xl font-bold mb-3 lg:mb-4 text-blue-700 border-b border-blue-200 pb-2 text-center lg:text-left">
            Past Presidents
          </h2>
        ...
        <div className="border-2 border-green-500 rounded-lg p-4 lg:p-6 shadow-lg bg-gradient-to-b from-green-50 to-white hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-xl lg:text-2xl font-bold mb-3 lg:mb-4 text-green-700 border-b border-green-200 pb-2 text-center lg:text-left">
            Past BOS Secretaries
          </h2>
          <ul className="space-y-1 lg:space-y-2 text-sm lg:text-base">
